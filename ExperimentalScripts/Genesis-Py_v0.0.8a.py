...
class PlotNotebook(wx.Panel):
    def __init__(self, parent, id=-1):
        ...
        self.nb = aui.AuiNotebook(self, size=(700, 500))
        sizer = wx.BoxSizer()
...
class App_Main_Frame(wx.Frame):
    ...
    def InitUI(self):
        ...
        AdmixCont.__init__(AdmixCont, self.panel)

        self.plotter = PlotNotebook(self.panel)
        #axes1 = self.plotter.add("Fig1").gca()
    ...
    def Admix_Import(self, e):
        # self.axes1 = self.plotter.add("Admixture Graph").gca()
        # print(self.axes1)

        self.child = AdmixImport(self, title="Admixture Graph")
        # AdmixImport.setAxes(self, self.axes1)

        # self.axes1.plot([1, 2, 3], [2, 4, 6])

        # AdmixImport.axes = self.graphPanel.axes
        self.child.Show()
        pub.sendMessage("GetAdmixPanel", message=self.plotter)
