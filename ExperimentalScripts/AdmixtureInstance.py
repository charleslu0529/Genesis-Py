...
# Note that the following code was taken from the Matplotlib documentation at https://matplotlib.org/gallery/user_interfaces/embedding_in_wx5_sgskip.html
...
class PlotNotebook(wx.Panel):
    def __init__(self, parent, id=-1):
        wx.Panel.__init__(self, parent, id=id, size=(0, 0))
        self.nb = aui.AuiNotebook(self, size=(0, 0))
        sizer = wx.BoxSizer()
...
# End of code taken from matplotlib Documentation ====================================================================
...
class AdmixController:
    ...
    def __init__(self, parent):
        ...
        pub.subscribe(self.getPanel, "GetAdmixPanel")
        ...
        self.graphPanel = wx.Panel(parent)
        self.plotter = PlotNotebook(self.graphPanel)
    ...
    def createGraph(self, axes):
        ...
        #axes.stackplot(x, self.sortedMatrix, colors=self.colourPal,
        #               alpha=self.graphAlpha)  # Defines the size of our x axis and our y values

        self.plotter = PlotNotebook(self.graphPanel)

        axes1 = self.plotter.add("Admixture Graph").gca()
        axes1.stackplot(x, self.sortedMatrix, colors=self.colourPal,
                       alpha=self.graphAlpha)  # Defines the size of our x axis and our y values

        # plt.show()

        # plotter = PlotNotebook(ex)
        # axes1 = plotter.add("Fig1").gca()
        # axes1.plot([1, 2, 3], [2, 4, 6])
